...
class TruckScheduleController extends Controller
{
    ...
    {
        $rows = TruckSchedule::orderByDesc('start_time')->get();
    ...
    public function update(Request $request, $id): JsonResponse
    {
        ...
        $row = TruckSchedule::where('id', $id)->firstOrFail();
        $row->update($data);
    ...
    {
        $row = TruckSchedule::where('id', $id)->first();
        if ($row) $row->delete();
